  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-8 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <p className="max-w-xs leading-relaxed">
              The Compass Assembly, is a warm and exciting Christian community,
              where everyone is valued and cherished.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              <p>Market Junction, Port Harcourt Aba Express Way</p>
              <p>(555) 123-4567</p>
        ...
        {/* Bottom bar */}
        <div
          className="flex flex-col items-center justify-between gap-3 border-t-4 pt-4 text-[0.75rem] uppercase tracking-wide md:flex-row"
          style={{ borderColor: "var(--color-secondary)" }}
        >
          ...
          <p className="opacity-80">
            Sunday Service • 8:00AM & 10:00 AM &nbsp;|&nbsp; Thursday Service •
            6:00 PM
          </p>
        </div>
      </div>
