...
const quicklinks = [
  ...
  { href: "/request", label: "Prayer Request" },
  { href: "workforce/", label: "Join Workforce" },
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
            <div>
              <p>
                ...
                <a
                  href="#"
                  className="block text-2xl font-medium text-[var(--color-foreground)] hover:opacity-75 sm:text-3xl"
                >
                  0123456789
                </a>
              </p>
              <ul className="mt-8 space-y-1 text-sm text-[var(--color-muted)]">
                <li>Sunday Service • 8:00AM & 10:00 AM</li>
                <li>Thursday Service • 6:00 PM</li>
              </ul>
